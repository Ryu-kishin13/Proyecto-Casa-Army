...
<body id="container-page-index">
    ...
    <div class="jumbotron" id="jumbotron-index">
      <h1><span class="tittles-pages-logo">Casa Army</span> <small style="color: #fff;">Cochabamba</small></h1>
      <p>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:20%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrese y hagase cliente de <span class="tittles-pages-logo">Casa Army</span> para recibir lo mejor de nuestros productos.</p>
                        <p><a href="registration.php" class="btn btn-info btn-block">Registrarse</a></p>   
                   </article>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/ropa-militar.jpg" alt="Ropa-militar" class="img-responsive">
                </div>
            </div>
        </div>
    </section>
